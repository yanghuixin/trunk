...
/**
 * Created by liuyp on 2017/9/19.
 */

public class DeviceAllotResponse extends BaseRes{//医院信息和药品信息
    ...
    public static class DatBean {
        ...
        private int pages;
        private List<DeviceAllotBean> rows;
        ...
        public List<DeviceAllotBean> getRows() {
            return rows;
        }
        public void setRows(List<DeviceAllotBean> rows) {
            this.rows = rows;
        }

        public static class DeviceAllotBean {
            /**

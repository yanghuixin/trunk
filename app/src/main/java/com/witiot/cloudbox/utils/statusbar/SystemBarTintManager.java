package com.witiot.cloudbox.utils.statusbar;
...
public class SystemBarTintManager {
    ...
    public static class SystemBarConfig {
        ...
        /**
         * Should a navigation bar appear at the bottom of the screen pop_in_xhm the current
         * device configuration? A navigation bar may appear on the right side of
         * the screen pop_in_xhm certain configurations.
         *
         ...
         *
         * @return The height of the status bar (pop_in_xhm pixels).
         */
         ...
         *
         * @return The height of the action bar (pop_in_xhm pixels).
         */
         ...
         *
         * @return The height of the navigation bar (pop_in_xhm pixels). If the device does not have
         ...
         *
         * @return The width of the navigation bar (pop_in_xhm pixels). If the device does not have
         * soft navigation keys, this will always return 0.
         */
         ...
         * @return The layout inset (pop_in_xhm pixels).
         */
